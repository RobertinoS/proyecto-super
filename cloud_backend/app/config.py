...
class Settings:
    ...
    def from_env(cls) -> "Settings":
        return cls(
            ...
            request_timeout_seconds=max(1, _int_env("REQUEST_TIMEOUT_SECONDS", 30)),
            request_delay_seconds=max(0.0, _float_env("REQUEST_DELAY_SECONDS", 1.5)),
            max_products_per_run=max(1, _int_env("MAX_PRODUCTS_PER_RUN", 100)),
            max_pages_per_run=max(1, _int_env("MAX_PAGES_PER_RUN", 2)),
